...
public class DoorRotator : MonoBehaviour
{
    ...
    public void OpenDoor()
    {
        if (!isOpen)
        {
            ...
            hinge.transform.rotation = Quaternion.Slerp(hinge.transform.rotation, Quaternion.Euler(0, 90, 0), timeOpening);
            timeOpening += Time.deltaTime;
            //}
        ...
        else
        {
            ...
            hinge.transform.rotation = Quaternion.Slerp(hinge.transform.rotation, oldRotation, timeOpening);
            timeOpening += Time.deltaTime;
        }
